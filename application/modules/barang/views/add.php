      ...
      <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control <?= form_error('harga_beli') ? 'is-invalid' : null ?>" id="harga_beli" name="harga_beli" placeholder="Masukan Harga Beli" value="<?= $this->input->post('harga_beli')?>">
                <span class="text-red"><?= form_error('harga_beli')?></span>
            </div>
            <div class="form-group">
                <label for="harga_jual">Harga Jual :</label>
                <input type="number" class="form-control <?= form_error('harga_jual') ? 'is-invalid' : null ?>" id="harga_jual" name="harga_jual" placeholder="Masukan Harga Jual" value="<?= $this->input->post('harga_jual')?>">
                <span class="text-red"><?= form_error('harga_jual')?></span>
            </div>
            <div class="form-group">
                <label for="stock">Stock :</label>
                <input type="number" class="form-control <?= form_error('stock') ? 'is-invalid' : null ?>" id="stock" name="stock" placeholder="Masukan Stock Barang" value="<?= $this->input->post('stock')?>">
